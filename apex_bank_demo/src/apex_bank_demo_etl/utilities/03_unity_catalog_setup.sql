...
-- MAGIC %md
-- MAGIC ## 2. Create Secure Masked Views
-- MAGIC
...
SELECT * FROM accounts_masked LIMIT 5;
...
-- MAGIC %md
-- MAGIC ## Bonus: Data Lineage Summary
-- MAGIC
...
-- MAGIC
-- MAGIC Complete the data model for the demo with synthetic audit log
